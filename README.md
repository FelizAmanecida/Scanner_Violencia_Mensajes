...
Se trata de un "Termómetro de Violencia" virtual, que en base a evaluar los mensajes virtuales  que le envía él a ella (Wathsapp, Messenger, etc), pueda indicarle A ELLA el NIVEL DE RIESGO DE ÉL DE SER VIOLENTO contra la mujer (en una escala del 1 al 5, donde 0:BAJO RIESGO, 1: CHANTAJE_EMOCIONAL, 2: CELOS_JUSTIFICACIÓN, 3:INSULTOS_HUMILLACIONES, 4:AMENAZAS_POSESIVIDAD). El hecho de evaluar las expresiones escritas de él (sus sentimientos y pensamientos) a través de Text Mining (rama de la Inteligencia Artificial) ayuda a detectar su nivel de VIOLENCIA PSICOLÓGICA, que es el primer tipo en manifestarse y también el momento donde aún se puede hacer algo por la relación. Esta propuesta fue  mi proyecto de tesis y se logró un prototipo muy básico, sería mucho mejor entrenar el modelo predictivo (clasificador automático) con data más realista, donada por una gran cantidad de peruanas y que sean copias reales de mensajes donde se observa violencia (completamente anónimos, solo se necesita el contenido del mensaje) en su forma natural (con emoticones, errores de ortografía, tiempo verbal correcto, modismos y formas de hablar reales) de forma que la herramienta pueda ser realmente útil a la población. No es invasivo a la privacidad pues debería poder ser consultado vía online copiando el texto de las redes de la usuaria a la web donde se despliegue el algoritmo, SE LE ALERTA A ELLA del nivel de riesgo que corre con él a fin de que ella TOME ACCIÓN (buscar ayuda, cortar la relación, tomar distancia o hasta denunciar) pues se busca que SE DÉ CUENTA del riesgo, dado que generalmente la víctima suele estar en negación, haya normalizado este comportamiento o hasta lo justifique con estereotipos o ideas con las que los agresores suelen manipularlas.

**Online, anónimo, sin miedo a ser juzgada como una víctima, y lo más importante, a tiempo. Prevenir es siempre mejor que lamentar y darse cuenta a tiempo del nivel de riesgo que una corre en una relación es el primer paso para actuar a tiempo y evitar avanzar en niveles y tipos de violencia.**
